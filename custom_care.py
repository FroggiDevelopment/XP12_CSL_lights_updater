                ...
                if "LIGHT_PARAM" in line or "LIGHT_NAMED" in line:
                    for light in WANTED_LIGHTS:
                        if light in line:
                            ...
                            list_of_aircraft_with_lights.append({"light_type": light, "lightcoordinates": coordinates})

        [unique_aircraft_lights.append(val) for val in list_of_aircraft_with_lights if val not in unique_aircraft_lights]
