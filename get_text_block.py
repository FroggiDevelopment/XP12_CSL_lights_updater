...
def repair_taxi_lights_dataref(input_file: Path, output_file: Path) -> str:

    file_content = get_original_object(original_object_file)

    return build_new_object(file_content)
...
if __name__ == "__main__":
    ...
    new_content = repair_taxi_lights_dataref(
        original_object_file, optimized_object_file
    )
